...
ALTER TABLE companies ADD COLUMN IF NOT EXISTS target_tier TEXT;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS source TEXT;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS campaign TEXT;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS last_touch_channel TEXT;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS next_step TEXT;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS buying_committee_status TEXT NOT NULL DEFAULT 'unknown';
ALTER TABLE companies ADD COLUMN IF NOT EXISTS do_not_contact BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS replied BOOLEAN NOT NULL DEFAULT false;
...
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS email_2 TEXT;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS phone_cell TEXT;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS phone_direct TEXT;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS phone_other TEXT;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS contact_role TEXT;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS do_not_contact BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS replied BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS not_interested BOOLEAN NOT NULL DEFAULT false;
